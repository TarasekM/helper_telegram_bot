...
class TestEventHandlers:
    ...
    def test_event(self, bot, update, event_chat_data, logger):
        assert bo.event(bot, update, event_chat_data) == bo.EVENT_NAME
        logger.info.assert_called_once()
        update.message.reply_text.assert_called_once()

    def test_event_name(self, bot, update, event_chat_data, logger):
        assert bo.event_name(bot, update, event_chat_data) == bo.EVENT_DATE
        logger.info.assert_called_once()
        assert bo.NAME in event_chat_data[bo.LEE].keys()
        update.message.reply_text.assert_called_once()

    def test_good_event_date(self, bot, good_date_update, event_chat_data, logger):
    ...
    def test_bad_event_date(self, bot, bad_date_update, event_chat_data, logger):
    ...
    def test_bad_format_event_date(self, bot, bad_format_date_update, event_chat_data, logger):
    ...
    def test_skip_event_loc(self, bot, update, event_chat_data, logger):
        assert bo.skip_event_loc(bot, update) == bo.EVENT_MSG
        logger.info.assert_called_once()
        update.message.reply_text.assert_called_once()

    def test_event_loc(self, bot, update, event_chat_data, logger):
